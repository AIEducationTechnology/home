...
public class Sign {
    ...
    public static void main(String[] args) throws Exception {
        String SecretAccessKey = "TVROaU56RXdNek15TldNek5EQmhaamhoWVdWak5HRTJOMkZpT0RWaVpESQ==";
        String AccessKeyID = "AKLTYzc1MTVhMjYwNGY2NGEyM2IwYTQ1M2VlYzQyNGU0MDc";
        // 请求地址
        String endpoint = "cv.cn-north-1.volcengineapi.com";
    ...
    public Map<String, String> getSignedHeaders(String httpMethod, Map<String, String> queryList, byte[] body, Date date) throws Exception {
        String xContentSha256 = hashSHA256(body);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd'T'HHmmss'Z'");
        sdf.setTimeZone(TimeZone.getTimeZone("GMT"));
        String xDate = sdf.format(date);
        ...
        String canonicalStringBuilder = httpMethod + "\n" +
                path + "\n" +
                querySB.toString() + "\n" +
                "host:" + host + "\n" +
                "x-date:" + xDate + "\n" +
        ...
        headers.put("Authorization", "HMAC-SHA256" +
                " Credential=" + ak + "/" + credentialScope +
                ", SignedHeaders=" + signHeader +
                ", Signature=" + signature);
